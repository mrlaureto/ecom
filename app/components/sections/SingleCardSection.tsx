        ...
        >
          {repeatedProducts.map((product, index) => (
            ...
            >
              ...
              <Image src="/star.png" alt="" width={20} height={15} className="object-contain" />
            </div>
          ))}
        </motion.div>
      </div>
            ...
            >
              <div className="w-full h-full">
                <div className="relative flex flex-col h-full w-full items-start justify-between">
                  <Image src="/star-large.png" alt="" className="absolute top-[-60px] right-[-60px] rotating-star" width={50} height={50} />
                  ...
                  <Image src={visibleProduct?.image_background || '/default-image.png'} alt="" width={300} height={400} className="h-[20rem] mb-[24px] w-full object-contain" />
